    ...
    switch (__method.intValue ())
    {
       case 0:  // DEMS/RegionalRecordManipulator/createMRecord
       {
         try {
           ...
           String $result = null;
           $result = this.createMRecord (firstName, lastName, employeeID, mailID, projects, location);
           out = $rh.createReply();
       ...
       case 1:  // DEMS/RegionalRecordManipulator/createERecord
       {
         try {
           ...
           String $result = null;
           $result = this.createERecord (firstName, lastName, employeeID, mailID, projectId);
           out = $rh.createReply();
           out.write_string ($result);
         } catch (RemoteException $ex) {
           out = $rh.createExceptionReply ();
       ...
       case 2:  // DEMS/RegionalRecordManipulator/editRecord
       {
         try {
           ...
           String $result = null;
           $result = this.editRecord (recordID, feildName, newValue);
           out = $rh.createReply();
           out.write_string ($result);
         } catch (RemoteException $ex) {
           out = $rh.createExceptionReply ();
       ...
       case 3:  // DEMS/RegionalRecordManipulator/getRecordCount
       {
         try {
           String $result = null;
       ...
       case 4:  // DEMS/RegionalRecordManipulator/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
